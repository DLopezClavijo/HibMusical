...
CREATE TABLE `canciones` (
  ...
  KEY `idArtista_idx` (`idCantante`),
  CONSTRAINT `idArtista` FOREIGN KEY (`idCantante`) REFERENCES `cantantes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-02-15 12:31:43
